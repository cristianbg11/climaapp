...
use Yii;
use \frontend\models\base\StationDataTemp as BaseStationDataTemp;

/**
 * This is the model class for table "station_datatemp".
 */
class StationDataTemp extends BaseStationDataTemp
{
    /**
     * @inheritdoc
     */
