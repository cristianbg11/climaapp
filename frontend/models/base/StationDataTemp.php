...
/**
 * This is the base model class for table "station_datatemp".
 *
 * @property string $id
 ...
 */
class StationDataTemp extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \frontend\models\StationDataTempQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \frontend\models\StationDataTempQuery(get_called_class());
    }
}
