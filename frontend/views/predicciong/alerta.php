...
$this->title = Yii::t('app', 'Consulta alertas de temperatura para plagas ');
...
?>
<h1>Alerta de Temperatura (Para Control de plagas y Enfermedades)</h1>
        ...
        [
            ...
            'buttons'=>[
                'verdem'=>function($url,$model,$key){
                    return Html::a('<i class="fa fa-eye"></i>',['predicciong/viewalerta','id'=>$model->id]);
                }
            ]
        ],
    ]; 
