...
use frontend\models\ProductorSearch;
...
class ProductorController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        $providerFinca = new \yii\data\ArrayDataProvider([
            'allModels' => $model->fincas,
        ]);
        return $this->render('view', [
            'model' => $this->findModel($id),
            'providerFinca' => $providerFinca,
        ]);
    }
    ...
    /**
     * 
     * Export Productor information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new Productor model by another data,
    ...
    * @return mixed
    */
    public function actionAddFinca()
    {
        if (Yii::$app->request->isAjax) {
            $row = Yii::$app->request->post('Finca');
            if (!empty($row)) {
                $row = array_values($row);
            }
            if((Yii::$app->request->post('isNewRecord') && Yii::$app->request->post('_action') == 'load' && empty($row)) || Yii::$app->request->post('_action') == 'add')
                $row[] = [];
            return $this->renderAjax('_formFinca', ['row' => $row]);
        } else {
            throw new NotFoundHttpException(Yii::t('app', 'The requested page does not exist.'));
        }
    }
